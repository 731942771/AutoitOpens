...
#AccAu3Wrapper_Res_Field=OriginalFilename|中徽教育-崔维友
#AccAu3Wrapper_Res_Field=ProductName|中徽教育-崔维友
#AccAu3Wrapper_Res_Field=ProductVersion|V1.0
#AccAu3Wrapper_Res_Field=InternalName|中徽教育-崔维友
#AccAu3Wrapper_Res_Field=FileDescription|中徽教育-崔维友
#AccAu3Wrapper_Res_Field=Comments|中徽教育-崔维友
...
;------------------------------------------ 初始化 ----------------------------------------------
Local $hGUI = GUICreate("中徽教育|威格灵|中关村在线-投影机数据采集系统", 600, 300)
